...
import { DcaModule } from '../src/dca/dca.module';
import { Conversion } from '../src/exchange-configurations/conversion.entity';
...
describe('Dca (e2e)', () => {
  ...
  const databaseName = 'db/tests/dca.sqlite';
    ...
    const moduleFixture: TestingModule = await Test.createTestingModule({
      imports: [
        TypeOrmModule.forRoot({
          ...
          entities: [ExchangeConfiguration, Conversion],
          synchronize: true,
        }),
        DcaModule,
